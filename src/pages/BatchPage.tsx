...
const BatchPage: React.FC = () => {
  ...
  return (
    <div className="animate-fadeIn">
      <Helmet>
        <title>Bulk QR Code Generator | Create Multiple QR Codes | GOQRGen</title>
        <meta name="description" content="Generate multiple QR codes at once with our bulk QR code creator. Perfect for product labels, event tickets, and inventory management. Save time with batch processing." />
