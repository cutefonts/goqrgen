...
const HistoryPage: React.FC = () => {
  ...
  return (
    <div className="animate-fadeIn">
      <Helmet>
        <title>QR Code History | Track & Manage Your QR Codes | GOQRGen</title>
        <meta name="description" content="Access and manage your QR code history. View, edit, and redownload your previously generated QR codes. Keep track of all your QR codes in one place." />
