...
const ScannerPage: React.FC = () => {
  ...
  return (
    <div className="animate-fadeIn">
      <Helmet>
        <title>QR Code Scanner | Scan QR Codes Online | GOQRGen</title>
        <meta name="description" content="Scan QR codes instantly with our free online QR code reader. No app download required. Works on all devices. Fast, secure, and easy to use." />
